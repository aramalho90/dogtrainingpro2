class OwnersController < ApplicationController
  ...
  def index
    ...
    @owners = @q.result().paginate(page: params[:page], per_page: 12)
  ...
  def create
    ...
    respond_to do |format|
      if @owner.save
        format.html { redirect_to owner_url(@owner) }
  ...
  private
    ...
    def owner_params
      params.require(:owner).permit(:name, :contact, :address, :zipcode, :city, :nif, :email, :referral, :obs)
    end
end
